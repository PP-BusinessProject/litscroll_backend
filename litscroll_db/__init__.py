from .models import (
    ...
    BookQuoteEngagementPrediction as BookQuoteEngagementPrediction,
    BookQuoteNarrative as BookQuoteNarrative,
    BookQuoteRanking as BookQuoteRanking,
    BookQuoteStyleAnalysis as BookQuoteStyleAnalysis,
